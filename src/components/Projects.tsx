                  ...
                  <div className="relative z-10">
                    <div className="flex items-start justify-between mb-4">
                      ...
                      <div className="flex gap-2">
                        {/* Not: Bu Github butonu proje kartlarında zaten vardı, 
                            ancak aşağıdaki "Site Linki" ve "Github Reposu" 
                            butonları varken buna gerek kalmayabilir. 
                            Şimdilik orijinal kodunuzdaki gibi bıraktım. */}
                        <Button
                          asChild
                          variant="outline"
                          size="sm"
                    ...
                    <div className="flex flex-wrap gap-2 mb-4">
                      {project.technologies.map((tech, techIndex) => (
                        <span key={techIndex} className="inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 border border-input bg-background text-foreground shadow-sm hover:bg-accent hover:text-accent-foreground h-9 px-4 py-2"
                        >
                          {tech}
                        </span>
                      ))}
